  ...
  return (
    <section className="bg-hero-gradient px-6 pb-12 pt-14">
      <div className="mx-auto max-w-6xl">
        <p className="inline-flex rounded-full border border-accent/35 bg-surface/80 px-4 py-2 text-sm text-amber">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <button onClick={onCreateRoute} className="btn-primary px-6 py-3">Создать маршрут</button>
          <button onClick={onShowPopular} className="btn-outline px-6 py-3">Смотреть популярные</button>
        </div>
      </div>
    </section>
  )
