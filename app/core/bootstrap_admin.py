...
def _ensure_admin_user(
    ...
    *,
    ...
    if (
        settings.enforce_bootstrap_admin_password
        and enforce_strong_password
        and not _is_strong_password(password)
    ):
        raise ValueError(
            "BOOTSTRAP_ADMIN_PASSWORD must be at least 12 chars and include upper/lowercase letters and digits"
        )
